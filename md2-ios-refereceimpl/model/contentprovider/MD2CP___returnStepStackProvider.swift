...
class MD2CP___returnStepStackProvider: MD2ContentProvider {
    
    typealias contentType = MD2Entity___ReturnStepStack
    ...
    func setValue(attribute: String, value: MD2Type) {
        ...
        print("[MD2CP___returnStepStackProvider] Update id=\(content!.internalId.toString()) set \(attribute) to '\(newValue.toString())'")
