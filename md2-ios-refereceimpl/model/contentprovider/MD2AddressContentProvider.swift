//
//  MD2AddressContentProvider.swift
...
class MD2AddressContentProvider: MD2ContentProviderType {
    
    let contentType = MD2Address.self
    ...
    init() {
        self.store = MD2LocalStoreFactory<MD2Address>().createStore()
    }
