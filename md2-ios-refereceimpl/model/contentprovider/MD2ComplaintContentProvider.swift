//
//  MD2ComplaintContentProvider.swift
...
class MD2ComplaintContentProvider: MD2ContentProviderType {
    
    let contentType = MD2Complaint.self
    ...
    init(content: MD2EntityType) {
        ...
        self.store = MD2LocalStoreFactory<MD2Complaint>().createStore()
    }
