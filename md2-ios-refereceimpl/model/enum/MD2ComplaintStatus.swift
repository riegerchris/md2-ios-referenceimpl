...
class MD2ComplaintStatus: MD2EnumType {
    ...
    var platformValue: MD2ComplaintStatus.EnumType?
    ...
    func clone() -> MD2Type {
        var newComplaintStatus = MD2ComplaintStatus()
    ...
    func equals(value : MD2Type) -> Bool {
        return platformValue != nil
                && value is MD2ComplaintStatus
                && platformValue?.rawValue == (value as! MD2ComplaintStatus).platformValue?.rawValue
    }
    ...
    func getAllValues() -> Array<String> {
        ...
        for elem in MD2ComplaintStatus.EnumType.allValues {
