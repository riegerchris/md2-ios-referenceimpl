...
protocol MD2Enum: MD2Type {
    ...
    // Unfortunately, platformValue cannot be specified as attribute of the interface MD2 according to the reference architecture
    // Reason: Specifying a generic type, e.g. via typealias does not work in Swift yet because subsequent methods will not accept MD2Enum as input anymore (error: Protocol of type MD2DataType can only be used as generic constraint...).
