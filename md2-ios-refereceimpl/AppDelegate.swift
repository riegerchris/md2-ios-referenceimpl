...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        let md2Controller = MD2Controller()
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("LocalData", withExtension: "momd")!
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator? = {
        ...
        let url = self.applicationDocumentsDirectory.URLByAppendingPathComponent("LocalData.sqlite")
        ...
        do {
            ...
            error = NSError(domain: "STORAGE_ERROR", code: 9999, userInfo: dict)
    ...
    /// Save the complete managed object context with the local data model
    func saveContext () {
