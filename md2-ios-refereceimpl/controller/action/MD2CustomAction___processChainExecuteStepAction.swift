//
//  MD2CustomAction___processChainExecuteStepAction.swift
//
...
class MD2CustomAction___processChainExecuteStepAction: MD2ActionType {
    ...
    let actionSignature: String = "MD2CustomAction___processChainExecuteStepAction"
	...
	if MD2String("" + MD2ContentProviderRegistry.instance.getContentProvider("__processChainControllerStateProvider")!.getValue("currentProcessChainStep")!.toString() + "").equals(MD2String("LocationProcessChain__LocationDetection")) {
		...
		let codeFragment1_if_0 = MD2GotoViewAction(actionSignature: "MD2CustomAction___processChainExecuteStepAction_1_if_0", 
		...
		let codeFragment1_elseif_0_0 = MD2GotoViewAction(actionSignature: "MD2CustomAction___processChainExecuteStepAction_1_elseif_0_0", 
